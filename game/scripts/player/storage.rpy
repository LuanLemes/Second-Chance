init python:
    ...
    def start_inventory_items():
        ...
        #   Flowers
        lily = InventoryItem( 0, "Lily", "Flower", True, 21, 2, 0, 0,"Lilium. Tall, majestic and strikingly-shaped")
        rose = InventoryItem(1, "Rose", "Flower", True, 28, 12, 0 , 2, "Rosa. Perhaps the most famous flower on the list")
        tulip = InventoryItem(2, "Tulip", "Flower", True, 21, 3, 0, 0, "Tulipa. Closely related to the lily and with a long history of cultivation.")
        carnation = InventoryItem(3, "Carnation", "Flower", True, 21, 4, 0, 0, "Scientific Name: Dianthus.")
        freesia = InventoryItem(4, "Freesia", "Flower", True, 49, 7, 0, 1, "What we call freesias are actually cultivated hybrids.")
        sunflower = InventoryItem(6, "Sunflower", "Flower", True, 56, 8, 0, 1, "known for its bright and cheery bloom.")
